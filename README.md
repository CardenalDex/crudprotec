...
1. **Swagger Generation:** The `swag` tool scans the code and updates the documentation.
...
> **Note:** Use this to register your first **Business** (getting a UUID), then a **Merchant**, and finally process a **Transaction**.
